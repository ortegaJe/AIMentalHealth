...
{{--     <p>{{ $mailData['body'] }}</p> --}}
    ...
    <p>
        ...
        Entiendo que a veces puede ser difícil enfrentarse a los desafíos que la vida nos presenta, pero quiero que sepas que no estás 
        solo/a en este proceso. Juntos/as podemos explorar las emociones y los pensamientos que estás experimentando, y trabajar en 
        estrategias para ayudarte a encontrar claridad y bienestar.
