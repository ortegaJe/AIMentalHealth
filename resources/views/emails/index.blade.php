...
<body>
    ...
    <p>
        Espero que te encuentre bien. Me gustaría recordarte que tenemos una cita programada para
        <b>{{ $mailData['body'] }}</b>.
        Estoy aquí para ti y estoy emocionado/a de poder brindarte el apoyo que necesitas en este viaje hacia una mejor
        salud mental.
        <br>
        ...
        experimentando, y
        trabajar en estrategias para ayudarte a encontrar claridad y bienestar.
        <br>
